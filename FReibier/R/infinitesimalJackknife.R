#' Deprecated: Compute variance of estimate from a "ranger" model
#' 
...
rangerInfJack = function(rf, newdata, calibrate = TRUE) { 
  ...
  .Defunct("rInfJackMulticlass", msg="Function deprecated, but available now in package ranger!")
...
rInfJack = function(pred, inbag, calibrate = TRUE, used.trees = NULL) {
  ...
  .Defunct("rInfJack", msg="Function deprecated, but available now in package ranger!")
